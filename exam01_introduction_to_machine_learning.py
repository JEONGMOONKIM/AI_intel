...
Original file is located at
    https://colab.research.google.com/drive/1iY1BsVfuysVYaqoOUk8ehWkpRkrXasrL
...
"""왜 100으로 나눠서 사이즈를 줄였을까? 스케일링을 하는 이유: mse곡선을 그려야 하는데 값이 크면 경사가 급격히 커짐. 발산함. running rate를 대입하기도 전에 값이 너무 커져버리기 때문에 비례적으로 사이즈를 줄임."""
...
model2.save('noise_after_learning.h5')
